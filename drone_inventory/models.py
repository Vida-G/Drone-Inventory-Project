...
# Creating our marsheller to pull/create k,v pairs out of Drone attributes
class DroneSchema(ma.Schema):
    class Meta:
        # detailing fields(attributes) to be pulled out of Drone Class
...
# takes a python class object like <Drone x2735578969>
# and iterates through our field and adds them into a dictionary as k,v pairs
# def marshall(drone):
#     a_dict = {}
